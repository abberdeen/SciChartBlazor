...
(function (Zoom) {
    ...
    function zoomTo(element, start, end) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sciChartSurface, wasmContext, xAxis, coordCalc, coordStart, coordend;
            return __generator(this, function (_b) {
                _a = (0, SciChartContext_1.resolveContext)(element), sciChartSurface = _a.sciChartSurface, wasmContext = _a.wasmContext;
                xAxis = sciChartSurface.xAxes.get(0);
                coordCalc = xAxis.getCurrentCoordinateCalculator();
                coordStart = coordCalc.getCoordinate(start);
                coordend = coordCalc.getCoordinate(end);
