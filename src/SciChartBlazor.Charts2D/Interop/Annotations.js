...
(function (Annotations) {
    function add(element, jsonString) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sciChartSurface, wasmContext, annotations, ids;
            var _b;
            return __generator(this, function (_c) {
                _a = (0, SciChartContext_1.resolveContext)(element), sciChartSurface = _a.sciChartSurface, wasmContext = _a.wasmContext;
                annotations = scichart_1.chartBuilder.buildAnnotations(jsonString);
                (_b = sciChartSurface.annotations).add.apply(_b, annotations);
                ids = annotations.map(function (i) {
                    return i.id;
                });
                return [2 /*return*/, ids];
            });
    ...
    function remove(element, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                _a = (0, SciChartContext_1.resolveContext)(element), sciChartSurface = _a.sciChartSurface, wasmContext = _a.wasmContext;
                item = sciChartSurface.annotations.getById(id);
