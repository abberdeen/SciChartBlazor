...
export function runExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { sciChartSurface, wasmContext } = yield initSciChart();
...
export function initSciChart() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { sciChartSurface, wasmContext } = yield SciChartSurface.create("scichart-root");
        ...
        sciChartSurface.chartModifiers.add(new ZoomPanModifier(), new ZoomExtentsModifier(), new MouseWheelZoomModifier(), new LegendModifier({ showCheckboxes: false, showLegend: true }));
